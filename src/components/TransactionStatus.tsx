    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-4 space-y-3">
        ...
        {txData.confirmations && (
          <div className="flex justify-between items-center">
            <span className="text-sm font-medium text-gray-700">Confirmations</span>
            <span className="text-sm text-gray-600">{txData.confirmations}</span>
          </div>
        )}
        ...
        {txData.gasUsed && (
          <div className="flex justify-between items-center">
            ...
            <span className="text-sm text-gray-600">{parseInt(txData.gasUsed).toLocaleString()}</span>
          </div>
        )}
      </div>
